...
import {
  ...
  setRefetch,
  deleteItemsByIds,
} from '../../stores/items/itemsSlice';
import { useAppDispatch, useAppSelector } from '../../stores/hooks';
import { useRouter } from 'next/router';
import { Field, Form, Formik } from 'formik';
import { DataGrid, GridColDef } from '@mui/x-data-grid';
import { loadColumns } from './configureItemsCols';
...
const TableSampleItems = ({
  ...
  useEffect(() => {
    if (itemsNotify.showNotification) {
      notify(itemsNotify.typeNotification, itemsNotify.textNotification);
    }
  }, [itemsNotify.showNotification]);
  ...
  const handleViewAction = (id: string) => {
    router.push(`/items/items-view/?id=${id}`);
  };
...
export default TableSampleItems;
