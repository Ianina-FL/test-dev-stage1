...
const config = {
  gcloud: {
    bucket: "fldemo-files",
    hash: "38bc4da31f1880189c043e89266249dd"
  },
  bcrypt: {
    saltRounds: 12
  },
  ...
  uploadDir: os.tmpdir(),
  email: {
    from: 'test-dev-stage <app@flatlogic.app>',
  ...
  project_uuid: '740a4c2e-d9a8-4e2e-839c-bedb923e0487',
...
config.pexelsQuery = 'interconnected departments illustration';
